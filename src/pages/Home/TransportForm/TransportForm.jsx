...
export default function TransportForm() {
	...
	return (
		<div
			id="home"
			className="relative bg-linear-to-br from-orange-50 via-white to-orange-50 pt-8 pb-20 px-4 overflow-hidden">
				...
				<div className="grid lg:grid-cols-2 gap-12 items-center">
					<div className="order-2 lg:order-1" data-aos="fade-right">
						<div className="relative group">
							<div className="absolute -inset-1 bg-linear-to-r from-orange-500 via-orange-600 to-orange-500 rounded-3xl blur-xl opacity-30 group-hover:opacity-50 transition-opacity duration-500"></div>

							<div className="relative bg-linear-to-br from-orange-500 via-orange-600 to-orange-700 rounded-3xl shadow-2xl p-8 transform hover:scale-[1.02] transition-all duration-500">
					...
					<div className="order-1 lg:order-2 space-y-6" data-aos="fade-left">
						<div className="inline-block">
							<span className="bg-linear-to-r from-orange-100 to-orange-50 text-orange-600 px-6 py-2 rounded-full text-sm uppercase tracking-wider shadow-lg">
						...
						<p className="text-xl text-gray-600 max-w-xl leading-relaxed">
							Experience world-class shipping solutions with our advanced
							logistics network. We deliver excellence, speed, and reliability
							in every shipment.
						</p>
						<div className="relative mt-8">
							<div className="absolute -inset-4 bg-linear-to-r from-orange-400 to-orange-600 rounded-3xl blur-2xl opacity-30 animate-pulse"></div>
							<img
								src={truckImg2}
								alt="Delivery Truck"
