...
const places = [
    {
        ...
        image: 'https://pathao.com/wp-content/uploads/2018/12/courier-merchant.jpeg',
    },
    {
        name: 'Chennai',
        hotels: '1,497 Hotels Available',
        image: 'https://pathao.com/bn/wp-content/uploads/sites/6/2018/12/courier-merchant.jpeg',
    },
    {
        name: 'Kathmandu',
        hotels: '1,152 Hotels Available',
        image: 'https://pathao.com/wp-content/uploads/2024/07/Product-Packaging-Tips-1024x536.jpeg',
    },
    {
        name: 'Bangkok',
        hotels: '4,551 Hotels Available',
        image: 'https://cdn.dribbble.com/userupload/10939780/file/original-f73e777a3856b8c5a528c4a857780f84.png',
    },
    {
        name: 'Singapore',
        hotels: '813 Hotels Available',
        image: 'https://pathao.com/bn/wp-content/uploads/sites/6/2024/07/%E0%A6%AA%E0%A6%BE%E0%A6%A0%E0%A6%BE%E0%A6%93-%E0%A6%95%E0%A7%81%E0%A6%B0%E0%A6%BF%E0%A6%AF%E0%A6%BC%E0%A6%BE%E0%A6%B0-%E0%A6%A1%E0%A7%87%E0%A6%B2%E0%A6%BF%E0%A6%AD%E0%A6%BE%E0%A6%B0%E0%A6%BF-%E0%A6%B8%E0%A6%BE%E0%A6%B0%E0%A7%8D%E0%A6%AD%E0%A6%BF%E0%A6%B8-%E0%A6%A6%E0%A6%BF%E0%A6%9A%E0%A7%8D%E0%A6%9B%E0%A7%87-%E0%A7%AC%E0%A7%AA-%E0%A6%9C%E0%A7%87%E0%A6%B2%E0%A6%BE%E0%A6%AF%E0%A6%BC.jpg',
    },
];
        ...
        <div className=" mb-10 max-w-7xl mx-auto">
            ...
            <div className="mb-8 px-4 text-center md:mb-12">
                ...
                <p className="mx-auto max-w-3xl text-gray-600">
                    Expand your travel horizons with new facets! Explore the world by choosing your ideal travel places in Asia, Europe,
                ...
                <div className="mx-auto flex h-72 items-center justify-center sm:h-80 md:h-96">
                    {places.map((destination, index) => {
                        ...
                        if (position === 'center') {
                            ...
                            transformClass = 'translate-x-[60%] sm:translate-x-[70%] md:translate-x-[85%] scale-75 sm:scale-85 md:scale-90';
                            zIndexClass = 'z-20';
                        ...
                        return (
                            ...
                            >
                                <div
                                    ...
                                    style={{
                                        transform:
                                            position === 'right' ? 'rotateY(-10deg)' : position === 'left' ? 'rotateY(10deg)' : 'rotateY(0deg)',
            ...
            <div className="mt-8 flex justify-center gap-2 sm:mt-12">
                {places.map((_, index) => (
                    <button
                        ...
                        disabled={isTransitioning}
                        className={`h-2 rounded-full transition-all duration-300 disabled:opacity-50 ${currentSlide === index ? 'w-8 bg-blue-500' : 'w-2 bg-gray-300 hover:bg-gray-400'
                            }`}
