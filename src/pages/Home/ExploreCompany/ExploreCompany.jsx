    ...
    const exploreData = [
        {
            ...
            type: 'Courier',
            status: 'active',
            cover_image: 'https://www.lalamove.com/hubfs/Sub%20banner_driver_dhaka%201.jpg',
        },
        {
            id: 2,
            ...
            type: 'Courier',
            status: 'active',
            cover_image: 'https://images.unsplash.com/photo-1566576912321-d58ddd7a6088?auto=format&w=800&q=80',
        },
        {
            id: 3,
            ...
            type: 'Courier',
            status: 'active',
            cover_image: 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?auto=format&w=800&q=80',
        },
        {
            id: 4,
            ...
            type: 'Courier',
            status: 'active',
            cover_image: 'https://png.pngtree.com/thumb_back/fh260/background/20230702/pngtree-swift-delivery-a-scooter-motorcycle-carrying-a-cardboard-parcel-box-for-image_3738919.jpg',
        },
        {
            id: 5,
            ...
            type: 'Courier',
            status: 'active',
            cover_image: 'https://i.shgcdn.com/d4a11c47-531a-4569-b1ef-653ed1c798b8/-/format/auto/-/preview/3000x3000/-/quality/lighter/',
        },
        {
            id: 6,
            ...
            type: 'Courier',
            status: 'active',
            cover_image: 'https://jetcourier.ca/wp-content/uploads/2022/11/Why-You-Should-Use-Personal-Delivery-Services.jpg',
        },
        {
            id: 7,
            ...
            type: 'Courier',
            status: 'active',
            cover_image: 'https://swyftcourier.ca/wp-content/uploads/2023/12/reliable-personal-delivery-in-vancouver.webp',
        },
        {
            id: 8,
            ...
            type: 'Courier',
            status: 'active',
            cover_image: 'https://img.freepik.com/premium-photo/courier-service-delivery-man-giving-parcel-box-customer_8087-1974.jpg',
        },
        {
            id: 9,
            ...
            type: 'Courier',
            status: 'active',
            cover_image: 'https://www.tour-sa.com/wp-content/uploads/2021/09/servicio-de-mensajeri%CC%81a-1080x675.jpg',
        },
        {
            id: 10,
            ...
            type: 'Courier',
            status: 'active',
            cover_image: 'https://5.imimg.com/data5/SELLER/Default/2024/7/435334571/MG/PM/CX/225731654/door-to-door-courier-service-500x500.jpg',
        },
        {
            id: 11,
            ...
            type: 'Courier',
            status: 'active',
            cover_image: 'https://images.unsplash.com/photo-1529070538774-1843cb3265df?auto=format&w=800&q=80',
        },
        {
            id: 12,
            ...
            type: 'Courier',
            status: 'active',
            cover_image: 'https://images.unsplash.com/photo-1605281317010-fe5ffe798166?auto=format&w=800&q=80',
        },
    ];


    return (
        <div className="relative container mx-auto px-4 py-10 sm:px-6 lg:px-8 lg:py-28 max-w-7xl mx-auto">
            ...
            <div className="mb-12 text-center">
                <h2 className="mb-4 text-2xl font-bold text-gray-900 lg:text-4xl">Delivery Moments Gallery</h2>
                <h3 className="mb-6 text-2xl font-bold text-indigo-500 lg:text-4xl">Real Deliveries. Real Stories</h3>
                <p className="mx-auto max-w-4xl text-lg text-gray-600">
                    Take a look at snapshots showcasing our courier operations and customer experiences.
                </p>
            </div>
                ...
                {exploreData.map((imageItem) => (
                    ...
                    >
                        <div
                            ...
                            style={{ backgroundImage: `url(${imageItem.cover_image})` }}
                        ></div>

                        <div className="absolute inset-0 bg-gradient-to-t from-black/70 opacity-50 transition-colors duration-400 group-hover:from-black/50"></div>
                        ...
                        <div className="absolute bottom-0 -right-100 rounded-md px-2 py-1 text-sm font-semibold duration-500 group-hover:bottom-0 group-hover:right-5 group-hover:block">
                            <img src={airPlaneImg} alt="" className="w-[80px]" />
                        </div>
