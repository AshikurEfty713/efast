			...
			<div className="relative z-10">
				...
				<div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
					<div className="grid grid-cols-1 gap-8 md:grid-cols-3 lg:gap-12 mb-12">
						...
						<div className="flex flex-col gap-4">
							<div className="flex items-center gap-2 mb-2">
								<div className="w-10 h-10 bg-gradient-to-br from-orange-400 to-orange-700 rounded-lg flex items-center justify-center">
									<span className="text-white font-bold text-lg">E</span>
								</div>
								<h3 className="text-xl font-bold text-white">Efast</h3>
							</div>
							<p className="text-gray-300 text-sm leading-relaxed">
								Providing reliable tech solutions since 1992. We're committed to delivering excellence and innovation.
							</p>
						...
						<div className="flex flex-col gap-4">
							<h4 className="text-base font-semibold text-white">{footerColumns[2].title}</h4>
					...
					<div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
						<p className="text-gray-400 text-sm">© {currentYear} EFast Ltd. All rights reserved.</p>
