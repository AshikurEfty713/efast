...
export default function Services() {
	...
	return (
		<div
			id="services"
			className="relative py-24 px-4 bg-linear-to-br from-gray-50 via-white to-orange-50 overflow-hidden">
			{/* Decorative Elements */}
			...
			<div className="container mx-auto max-w-7xl relative z-10">
				...
				<div className="max-w-3xl mb-16" data-aos="fade-up">
					...
					<p className="text-gray-700 text-lg leading-relaxed mb-8">
						Nam libero justo, lacerate a, ultrices ac, mattis nox, bibendum vel,
						justo, sed ultrices purus nibh sed lectus. Praesent nec nisl a purus
						blandit viverra. Proin gravida nibh vel velit auctor aliquet
						bibendum auctor mauris.
					</p>

					<button className="btn btn-lg bg-linear-to-r from-orange-500 to-orange-600 text-white border-0 hover:shadow-2xl transition-all duration-300 hover:scale-105">
						Book Services Now
					</button>
				</div>
				...
				<div className="mt-20 text-center" data-aos="fade-up">
					<div className="relative inline-block">
						<div className="absolute inset-0 bg-linear-to-r from-orange-500 to-orange-600 rounded-3xl blur-2xl opacity-30"></div>
						<div className="relative bg-linear-to-r from-orange-500 to-orange-600 text-white p-12 rounded-3xl shadow-2xl">
							<h3 className="text-3xl mb-4">Need a Custom Solution?</h3>
							<p className="text-lg mb-6 opacity-90">
								Our team is ready to create a tailored logistics plan for your
								unique requirements.
							</p>
